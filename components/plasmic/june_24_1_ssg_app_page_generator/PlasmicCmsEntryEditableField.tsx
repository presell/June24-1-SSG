...
import sty from "./PlasmicCmsEntryEditableField.module.css"; // plasmic-import: -X2JPG3VaqQ0/css

import EditSvgrepoComsvgIcon from "./icons/PlasmicIcon__EditSvgrepoComsvg"; // plasmic-import: wd9vv5xriAmX/icon
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__m1Rkw, {
            [sty.freeBoxeditable__m1RkWkSeuJ]: hasVariant(
              $state,
              "editable",
              "editable"
            ),
            [sty.freeBoxediting_type_image__m1Rkw1X2LyKEkLa]:
              hasVariant($state, "editing", "editing") &&
              hasVariant($state, "type", "image"),
            [sty.freeBoxloading__m1RkWrJ7Yz]: hasVariant(
              $state,
              "loading",
              "loading"
            ),
            [sty.freeBoxtype_image__m1RkWkEkLa]: hasVariant(
              $state,
              "type",
              "image"
            ),
            [sty.freeBoxtype_image_editable__m1RkWkEkLaKSeuJ]:
              hasVariant($state, "editable", "editable") &&
              hasVariant($state, "type", "image"),
            [sty.freeBoxtype_text__m1Rkwh4Sy6]: hasVariant(
              $state,
              "type",
              "text"
            )
        ...
        >
          ...
          {(hasVariant($state, "editing", "editing") ? false : true) ? (
            <div
              className={classNames(projectcss.all, sty.freeBox__aq08N, {
                [sty.freeBoxborderRadius__10Px__aq08NEny9Z]: hasVariant(
                  $state,
                  "borderRadius",
                  "_10Px"
                ),
                [sty.freeBoxeditable__aq08NkSeuJ]: hasVariant(
                  $state,
                  "editable",
                  "editable"
                ),
                [sty.freeBoxediting__aq08N1X2Ly]: hasVariant(
                  $state,
                  "editing",
                  "editing"
                ),
                [sty.freeBoxloading__aq08NrJ7Yz]: hasVariant(
                  $state,
                  "loading",
                  "loading"
                ),
                [sty.freeBoxtype_image__aq08NkEkLa]: hasVariant(
                  $state,
                  "type",
                  "image"
                ),
                [sty.freeBoxtype_image_editable__aq08NkEkLaKSeuJ]:
                  hasVariant($state, "type", "image") &&
                  hasVariant($state, "editable", "editable"),
                [sty.freeBoxtype_text__aq08NH4Sy6]: hasVariant(
                  $state,
                  "type",
                  "text"
                )
            ...
            >
              {(
                ...
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__x7Dm, {
                    [sty.imgborderRadius__0Px__x7Dm5LqF]: hasVariant(
                      $state,
                      "borderRadius",
                      "_0Px"
                    ),
                    [sty.imgborderRadius__10Px__x7DmEny9Z]: hasVariant(
                      $state,
                      "borderRadius",
                      "_10Px"
                    ),
                    [sty.imgeditable__x7DmkSeuJ]: hasVariant(
                      $state,
                      "editable",
                      "editable"
                    ),
                    [sty.imgediting_type_image__x7Dm1X2LyKEkLa]:
                      hasVariant($state, "editing", "editing") &&
                      hasVariant($state, "type", "image"),
                    [sty.imgtype_image__x7DmkEkLa]: hasVariant(
                      $state,
                      "type",
                      "image"
                    ),
                    [sty.imgtype_image_editable__x7DmkEkLaKSeuJ]:
                      hasVariant($state, "type", "image") &&
                      hasVariant($state, "editable", "editable")
                  })}
                  displayHeight={"auto"}
          ...
          {(
            ...
            <div
              className={classNames(projectcss.all, sty.freeBox__nzrrO, {
                [sty.freeBoxediting__nzrrO1X2Ly]: hasVariant(
                  $state,
                  "editing",
                  "editing"
                ),
                [sty.freeBoxediting_type_image__nzrrO1X2LyKEkLa]:
                  hasVariant($state, "editing", "editing") &&
                  hasVariant($state, "type", "image")
              })}
              onBlur={async event => {
            ...
            >
              {(
                ...
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___2WspA, {
                    [sty.imgeditable___2WspAkSeuJ]: hasVariant(
                      $state,
                      "editable",
                      "editable"
                    ),
                    [sty.imgediting___2WspA1X2Ly]: hasVariant(
                      $state,
                      "editing",
                      "editing"
                    ),
                    [sty.imgediting_type_image___2WspA1X2LyKEkLa]:
                      hasVariant($state, "editing", "editing") &&
                      hasVariant($state, "type", "image"),
                    [sty.imgtype_image___2WspAkEkLa]: hasVariant(
                      $state,
                      "type",
                      "image"
                    )
              ...
              <div
                className={classNames(projectcss.all, sty.freeBox__rc4G1, {
                  [sty.freeBoxediting__rc4G11X2Ly]: hasVariant(
                    $state,
                    "editing",
                    "editing"
                  ),
                  [sty.freeBoxediting_type_image__rc4G11X2LyKEkLa]:
                    hasVariant($state, "editing", "editing") &&
                    hasVariant($state, "type", "image")
                })}
              >
                {(() => {
                  const child$Props = {
                    ...
                    className: classNames("__wab_instance", sty.curValueInput, {
                      ...
                      [sty.curValueInputediting_type_image]:
                        hasVariant($state, "editing", "editing") &&
                        hasVariant($state, "type", "image")
                    }),
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__mrc3G, {
              [sty.imgloading__mrc3GrJ7Yz]: hasVariant(
                $state,
                "loading",
                "loading"
              )
            ...
            loading={"lazy"}
            src={{
              src: "/plasmic/june_24_1_ssg_app_page_generator/images/icons8DotsLoadinggif.gif",
              fullWidth: 30,
              fullHeight: 840,
      ...
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__wDy33, {
            [sty.freeBoxloading__wDy33RJ7Yz]: hasVariant(
              $state,
              "loading",
              "loading"
            ),
            [sty.freeBoxtype_image__wDy33KEkLa]: hasVariant(
              $state,
              "type",
              "image"
            ),
            [sty.freeBoxtype_image_loading__wDy33KEkLaRJ7Yz]:
              hasVariant($state, "loading", "loading") &&
              hasVariant($state, "type", "image")
          })}
        >
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__mAkAu)}
            displayHeight={"15px"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
            ...
            loading={"lazy"}
            src={{
              src: "/plasmic/june_24_1_ssg_app_page_generator/images/eCvOxPXugngif.gif",
              fullWidth: 150,
              fullHeight: 150,
              aspectRatio: undefined
            }}
          ...
          <LottieWrapper
            ...
            className={classNames("__wab_instance", sty.lottie__rEm2H)}
            preview={true}
          />
          ...
          <LottieWrapper
            ...
            className={classNames("__wab_instance", sty.lottie__oIHr, {
              [sty.lottieloading__oIHrrJ7Yz]: hasVariant(
                $state,
                "loading",
                "loading"
              ),
              [sty.lottietype_image__oIHrkEkLa]: hasVariant(
                $state,
                "type",
                "image"
              ),
              [sty.lottietype_image_loading__oIHrkEkLaRJ7Yz]:
                hasVariant($state, "loading", "loading") &&
                hasVariant($state, "type", "image")
            })}
            preview={true}
